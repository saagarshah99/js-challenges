...
export class Loader {
   ...
   */
  displayLoader() {this.htmlRef.innerHTML = "<div class=\"loader\"></div>";}  
  
  /**
   * Updates the htmlRef.innerHTML to remove the loader's html.
   */
  removeLoader() {this.htmlRef.innerHTML = "";}
}
...
export class Engine {
   ...
   * Create an engine.
   */
  constructor() {this.engineIsRunning = false;}
...
export class Modal {
  ...
  // WRITE RENDER HTML METHOD HERE - test checks specifically for "correct" indentation
  renderHtml()
  {
  ...
  displayModal() {this.htmlRef.classList.toggle("hide");}
}
